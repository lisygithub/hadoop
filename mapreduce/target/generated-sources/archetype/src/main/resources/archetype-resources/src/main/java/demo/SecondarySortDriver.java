...
import org.apache.hadoop.${artifactId}.Partitioner;
...
public class SecondarySortDriver {
    ...
    public static void main(String[] args) {
        try {
            ...
            FileInputFormat.addInputPath(job,new Path("E:${symbol_escape}${symbol_escape}workspace${symbol_escape}${symbol_escape}hadoop${symbol_escape}${symbol_escape}temp${symbol_escape}${symbol_escape}demo2.txt"));
